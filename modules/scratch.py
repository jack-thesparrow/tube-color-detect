...
known_colors = {
    ...
    # "black": scale_hsv(222.5, 46.2, 20.4),
...
def get_color_segments(hsv_img, known_colors, tolerances, row_step=5):
...
def approximate_wide_bands(results, global_min):
    ...
    for filename, data in results.items():
        ...
        for color_key, area in data["areas"].items():
            ...
            estimated_slots = max(1, round(ratio))
